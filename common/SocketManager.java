...
public class SocketManager {
	...
	public static void MULTI_SEND_Af_PACKET(PrintWriter out, int position,
			int totalAbo, int totalNonAbo, String subscribe, int queueID) {
		StringBuilder packet = new StringBuilder();
		packet.append("Af").append(position).append("|").append(totalAbo)
				.append("|").append(totalNonAbo).append("|").append(subscribe)
	...
	public static void REALM_SEND_GAME_SERVER_IP(PrintWriter out, int guid,
			boolean isHost) {
		String packet = "A";
		if (Ancestra.CONFIG_USE_IP) {
			String ip = Ancestra.CONFIG_IP_LOOPBACK && isHost ? CryptManager
					.CryptIP("127.0.0.1")
					+ CryptManager.CryptPort(Ancestra.CONFIG_GAME_PORT)
					: Ancestra.GAMESERVER_IP;
			packet += "XK" + ip + guid;
		} else {
	...
	public static void GAME_SEND_PERSO_LIST(PrintWriter out,
			Map<Integer, Personnage> persos, int subscriber) {
		StringBuilder packet = new StringBuilder();
	...
	public static void GAME_SEND_Re_PACKET(Personnage out, String sign,
			Dragodinde DD) {
	...
	public static void GAME_SEND_ASK(PrintWriter out, Personnage perso) {
		StringBuilder packet = new StringBuilder();
		packet.append("ASK|").append(perso.get_GUID()).append("|")
				.append(perso.get_name()).append("|");
		packet.append(perso.get_lvl()).append("|").append(perso.get_classe())
				.append("|").append(perso.get_sexe());
		packet.append("|")
				.append(perso.get_gfxID())
				.append("|")
				.append((perso.get_color1() == -1 ? "-1" : Integer
						.toHexString(perso.get_color1())));
		packet.append("|")
				.append((perso.get_color2() == -1 ? "-1" : Integer
						.toHexString(perso.get_color2()))).append("|");
		packet.append(
				(perso.get_color3() == -1 ? "-1" : Integer.toHexString(perso
						.get_color3()))).append("|");
	...
	public static void GAME_SEND_SEE_FRIEND_CONNEXION(PrintWriter out,
			boolean see) {
	...
	public static void GAME_SEND_MAPDATA(PrintWriter out, int id, String date,
			String key) {
	...
	public static void GAME_SEND_MAP_MOBS_GMS_PACKETS(PrintWriter out,
			Carte carte) {
	...
	public static void GAME_SEND_MAP_OBJECTS_GDS_PACKETS(PrintWriter out,
			Carte carte) {
	...
	public static void GAME_SEND_MAP_NPCS_GMS_PACKETS(PrintWriter out,
			Carte carte) {
	...
	public static void GAME_SEND_MAP_PERCO_GMS_PACKETS(PrintWriter out,
			Carte carte) {
	...
	public static void GAME_SEND_ERASE_ON_MAP_TO_MAP(Carte map, int guid) {
		...
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Map " + map.get_id() + ": Send>>"
					+ packet);
	}
	...
	public static void GAME_SEND_ERASE_ON_MAP_TO_FIGHT(Fight f, int guid) {
		...
		for (int z = 0; z < f.getFighters(1).size(); z++) {
			if (f.getFighters(1).get(z).getPersonnage().get_compte()
					.getGameThread() == null)
				continue;
			send(f.getFighters(1).get(z).getPersonnage().get_compte()
					.getGameThread().get_out(), packet);
		}
		for (int z = 0; z < f.getFighters(2).size(); z++) {
			if (f.getFighters(2).get(z).getPersonnage().get_compte()
					.getGameThread() == null)
				continue;
			send(f.getFighters(2).get(z).getPersonnage().get_compte()
					.getGameThread().get_out(), packet);
		}
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Fighter ID " + f.get_id()
					+ ": Send>>" + packet);
	}
	...
	public static void GAME_SEND_ON_FIGHTER_KICK(Fight f, int guid, int team) {
		...
		for (Fighter F : f.getFighters(team)) {
			if (F.getPersonnage() == null
				...
				continue;
			send(F.getPersonnage().get_compte().getGameThread().get_out(),
					packet);
		}
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Fighter ID " + f.get_id()
	...
	public static void GAME_SEND_ALTER_FIGHTER_MOUNT(Fight fight,
		...
		StringBuilder packet = new StringBuilder();
		packet.append("GM|-").append(guid).append((char) 0x00)
				.append(fighter.getGmPacket('+'));
		...
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Fight ID " + fight.get_id()
					+ ": Send>>" + packet);
	}
	...
	public static void GAME_SEND_MAP_NEW_DUEL_TO_MAP(Carte map, int guid,
			int guid2) {
	...
	public static void GAME_SEND_CANCEL_DUEL_TO_MAP(Carte map, int guid,
			int guid2) {
	...
	public static void GAME_SEND_MAP_START_DUEL_TO_MAP(Carte map, int guid,
			int guid2) {
	...
	public static void GAME_SEND_FIGHT_GJK_PACKET_TO_FIGHT(Fight fight,
			...
			int type) {
		StringBuilder packet = new StringBuilder();
		packet.append("GJK").append(state).append("|").append(cancelBtn)
				.append("|").append(duel).append("|").append(spec).append("|")
				.append(time).append("|").append(type);
	...
	public static void GAME_SEND_GAME_ADDFLAG_PACKET_TO_MAP(Carte map,
			int arg1, int guid1, int guid2, int cell1, String str1, int cell2,
			String str2) {
		StringBuilder packet = new StringBuilder();
		packet.append("Gc+").append(guid1).append(";").append(arg1).append("|")
				.append(guid1).append(";").append(cell1).append(";")
				.append(str1).append("|").append(guid2).append(";")
				.append(cell2).append(";").append(str2);
		for (Personnage z : map.getPersos())
	...
	public static void GAME_SEND_GAME_ADDFLAG_PACKET_TO_PLAYER(Personnage p,
			Carte map, int arg1, int guid1, int guid2, int cell1, String str1,
	...
	public static void GAME_SEND_ADD_IN_TEAM_PACKET_TO_MAP(Carte map,
			int teamID, Fighter perso) {
		StringBuilder packet = new StringBuilder();
		packet.append("Gt").append(teamID).append("|+").append(perso.getGUID())
				.append(";").append(perso.getPacketsName()).append(";")
				.append(perso.get_lvl());
		for (Personnage z : map.getPersos())
			send(z, packet.toString());
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Map: Send>>" + packet.toString());
	...
	public static void GAME_SEND_ADD_IN_TEAM_PACKET_TO_PLAYER(Personnage p,
			Carte map, int teamID, Fighter perso) {
		StringBuilder packet = new StringBuilder();
		packet.append("Gt").append(teamID).append("|+").append(perso.getGUID())
				.append(";").append(perso.getPacketsName()).append(";")
				.append(perso.get_lvl());
	...
	public static void GAME_SEND_REMOVE_IN_TEAM_PACKET_TO_MAP(Carte map,
			int teamID, Fighter perso) {
		StringBuilder packet = new StringBuilder();
		packet.append("Gt").append(teamID).append("|-").append(perso.getGUID())
				.append(";").append(perso.getPacketsName()).append(";")
	...
	public static void GAME_SEND_MAP_MOBS_GM_PACKET(Carte map,
	...
	public static void GAME_SEND_ON_EQUIP_ITEM_FIGHT(Personnage _perso,
			Fighter f, Fight F) {
		String packet = _perso.parseToOa();
	...
	public static void GAME_SEND_FIGHT_CHANGE_PLACE_PACKET_TO_FIGHT(
			Fight fight, int teams, Carte map, int guid, int cell) {
	...
	public static void GAME_SEND_FIGHT_CHANGE_OPTION_PACKET_TO_MAP(Carte map,
	...
	public static void GAME_SEND_GJK_PACKET(Personnage out, int state,
			int cancelBtn, int duel, int spec, int time, int unknown) {
		StringBuilder packet = new StringBuilder();
		packet.append("GJK").append(state).append("|").append(cancelBtn)
				.append("|").append(duel).append("|").append(spec).append("|")
				.append(time).append("|").append(unknown);
		send(out, packet.toString());
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Send>>" + packet.toString());
	}

	public static void GAME_SEND_FIGHT_PLACES_PACKET(PrintWriter out,
	...
	public static void GAME_SEND_eUK_PACKET_TO_MAP(Carte map, int guid,
			int emote) {
	...
	public static void GAME_SEND_MESSAGE(Personnage out, String mess,
			String color) {
	...
	public static void GAME_SEND_MESSAGE_TO_MAP(Carte map, String mess,
			String color) {
		String packet = "cs<font color='#" + color + "'>" + mess + "</font>";
		for (Personnage z : map.getPersos())
			send(z, packet);
	...
	public static void GAME_SEND_GA903_ERROR_PACKET(PrintWriter out, char c,
			int guid) {
	...
	public static void GAME_SEND_GIC_PACKETS_TO_FIGHT(Fight fight, int teams) {
		...
		for (Fighter p : fight.getFighters(3)) {
			if (p.get_fightCell() == null)
				continue;
			packet.append(p.getGUID()).append(";")
					.append(p.get_fightCell().getID()).append(";1|");
		}
	...
	public static void GAME_SEND_GIC_PACKET_TO_FIGHT(Fight fight, int teams,
			Fighter f) {
		StringBuilder packet = new StringBuilder();
		packet.append("GIC|").append(f.getGUID()).append(";")
				.append(f.get_fightCell().getID()).append(";1|");
	...
	public static void GAME_SEND_GTM_PACKET_TO_FIGHT(Fight fight, int teams) {
		...
		for (Fighter f : fight.getFighters(3)) {
			...
			if (f.isDead()) {
				...
				packet.append("0;").append(f.getPDV() + ";")
						.append(f.getPA() + ";").append(f.getPM() + ";");
			packet.append((f.isHide() ? "-1" : f.get_fightCell().getID()))
					.append(";");// On envoie pas la cell d'un invisible :p
			packet.append(";");// ??
	...
	public static void GAME_SEND_GAMETURNSTART_PACKET(Personnage P, int guid,
			int time) {
		String packet = "GTS" + guid + "|" + time;
		send(P, packet);
		if (Ancestra.CONFIG_DEBUG)
	...
	public static void GAME_SEND_GA_PACKET_TO_FIGHT(Fight fight, int teams,
		...
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Fight("
					+ fight.getFighters(teams).size() + ") : Send>>" + packet);
	}

	public static void ENVIAR_SB_HECHIZO_BOOST(Personnage perso,
			String modificacion) {
	...
	public static void GAME_SEND_GA_PACKET(PrintWriter out, String actionID,
	...
	public static void GAME_SEND_SPELL_UPGRADE_SUCCED(PrintWriter _out,
	...
	public static void GAME_SEND_SPELL_UPGRADE_SUCCED(Personnage perso,
			int spellID, int level) {
		String packet = "SUK" + spellID + "~" + level;
		send(perso, packet);
		if (Ancestra.CONFIG_DEBUG)
	...
	public static void GAME_SEND_FIGHT_GE_PACKET_TO_FIGHT(Fight fight,
			int teams, int win) {
	...
	public static void GAME_SEND_FIGHT_GE_PACKET(PrintWriter out, Fight fight,
			int win) {
		String packet = fight.GetGE(win);
		send(out, packet);
		if (Ancestra.CONFIG_DEBUG)
	...
	public static void GAME_SEND_FIGHT_GIE_TO_FIGHT(Fight fight, int teams,
		...
		StringBuilder packet = new StringBuilder();
		packet.append("GIE").append(mType).append(";").append(cible)
				.append(";").append(value).append(";").append(mParam2)
				.append(";").append(mParam3).append(";").append(mParam4)
				.append(";").append(turn).append(";").append(spellID);
		for (Fighter f : fight.getFighters(teams)) {
			if (f.hasLeft() || f.getPersonnage() == null)
				continue;
			if (f.getPersonnage().isOnline())
	...
	public static void GAME_SEND_MAP_FIGHT_GMS_PACKETS(Fight fight, Carte map,
			Personnage _perso) {
		String packet = map.getFightersGMsPackets();
		send(_perso, packet);
	...
	public static void GAME_SEND_cMK_PACKET(Personnage perso, String suffix,
	...
	public static void GAME_SEND_cMK_PACKET_TO_MAP(Carte map, String suffix,
			int guid, String name, String msg) {
		String packet = "cMK" + suffix + "|" + guid + "|" + name + "|" + msg;
		for (Personnage z : map.getPersos())
			send(z, packet);
	...
	public static void GAME_SEND_cMK_PACKET_TO_ALL(Personnage perso,
		...
		if (perso.get_lvl() < 6) {
			SocketManager
					.GAME_SEND_MESSAGE(
							perso,
							"Ce canal n'est accessible qu'� partir du niveau <b>6</b>.",
		...
		for (Personnage perso1 : World.getOnlinePersos())
			send(perso1, packet);
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: ALL("
					+ World.getOnlinePersos().size() + "): Send>>" + packet);
	}

	public static void GAME_SEND_cMK_PACKET_TO_ALIGN(String suffix, int guid,
			String name, String msg, Personnage _perso) {
		String packet = "cMK" + suffix + "|" + guid + "|" + name + "|" + msg;
		for (Personnage perso : World.getOnlinePersos()) {
	...
	public static void GAME_SEND_ECK_PACKET(PrintWriter out, int type,
			String str) {
		String packet = "ECK" + type;
		if (!str.equals(""))
			packet += "|" + str;
	...
	public static void GAME_SEND_ITEM_VENDOR_LIST_PACKET(PrintWriter out,
			NPC npc) {
	...
	public static void GAME_SEND_ITEM_LIST_PACKET_PERCEPTEUR(PrintWriter out,
			Percepteur perco) {
	...
	public static void GAME_SEND_ITEM_LIST_PACKET_SELLER(Personnage p,
			Personnage out) {
	...
	public static void GAME_SEND_CONSOLE_MESSAGE_PACKET(PrintWriter out,
			String mess) {
	...
	public static void GAME_SEND_OBJECT_QUANTITY_PACKET(Personnage out,
			Objet obj) {
	...
	public static void ENVIAR_OAKO_APARECER_OBJETO(PrintWriter out, String str) {
		String packet = "OAKO" + str;
		send(out, packet);
		if (Ancestra.CONFIG_DEBUG)
			System.out.println("APARECER OBJEVIVO: PERSO>>  " + packet);
	}
	...
	public static void GAME_SEND_EXCHANGE_REQUEST_OK(PrintWriter out, int guid,
			int guidT, int msgID) {
	...
	public static void GAME_SEND_EXCHANGE_MOVE_OK(Personnage out, char type,
	...
	public static void GAME_SEND_EXCHANGE_OTHER_MOVE_OK(PrintWriter out,
	...
	public static void GAME_SEND_EXCHANGE_OK(PrintWriter out, boolean ok,
			int guid) {
	...
	public static void GAME_SEND_GROUP_INVITATION_ERROR(PrintWriter out,
			String s) {
		String packet = "PIE" + s;
		send(out, packet);
		if (Ancestra.CONFIG_DEBUG)
	...
	public static void GAME_SEND_GROUP_INVITATION(PrintWriter out, String n1,
			String n2) {
	...
	public static void GAME_SEND_cMK_PACKET_TO_GROUP(Group g, String s,
			int guid, String name, String msg) {
	...
	public static void GAME_SEND_FIGHT_DETAILS(PrintWriter out, Fight fight) {
		...
		for (Fighter f : fight.getFighters(1))
			packet.append(f.getPacketsName()).append("~").append(f.get_lvl())
					.append(";");
		packet.append("|");
	...
	public static void GAME_SEND_GA_PACKET_TO_MAP(Carte map,
			String gameActionID, int actionID, String s1, String s2) {
	...
	public static void GAME_SEND_JX_PACKET(Personnage perso,
			ArrayList<StatsMetier> SMs) {
		StringBuilder packet = new StringBuilder();
		packet.append("JX");
		for (StatsMetier sm : SMs) {
			packet.append("|").append(sm.getTemplate().getId()).append(";")
					.append(sm.get_lvl()).append(";")
	...
	public static void GAME_SEND_JO_PACKET(Personnage perso,
			ArrayList<StatsMetier> SMs) {
		for (StatsMetier sm : SMs) {
			String packet = "JO" + sm.getPosicion() + "|" + sm.getOptBinValue()
					+ "|" + sm.getSlotsPublico();
			send(perso, packet);
			if (Ancestra.CONFIG_DEBUG)
				GameServer.addToSockLog("Game: Send>>" + packet);
	...
	public static void GAME_SEND_JS_PACKET(Personnage perso,
			ArrayList<StatsMetier> SMs) {
		String packet = "JS";
		for (StatsMetier sm : SMs) {
			packet += sm.parseJS();
	...
	public static void GAME_SEND_JR_PACKET(Personnage perso,int job)
	{
		String packet = "JR" + job;
		send(perso, packet);
		if(Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Send>>" + packet);
	}
	...
	public static void GAME_SEND_FIGHT_SHOW_CASE(ArrayList<PrintWriter> PWs,
			int guid, int cellID) {
	...
	public static void GAME_SEND_IO_PACKET_TO_MAP(Carte map, int guid,
			String str) {
	...
	public static void GAME_SEND_FRIEND_ONLINE(Personnage logando,
			Personnage amigo) {
		String packet = "Im0143;" + logando.get_compte().get_pseudo()
				+ " (<b><a href='asfunction:onHref,ShowPlayerPopupMenu,"
				+ logando.get_name() + "'>" + logando.get_name() + "</a></b>)";
		send(amigo, packet);
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Send>>" + packet);
	}
	...
	public static void GAME_SEND_Rp_PACKET(Personnage perso, MountPark MP) {
		...
		packet.append("Rp").append(MP.get_owner()).append(";")
				.append(MP.get_price()).append(";").append(MP.get_size())
	...
	public static void GAME_SEND_OS_PACKET(Personnage perso, int pano) {
		...
		if (num <= 0)
			...
			if (IS != null) {
				...
				packet.append(items.toString())
						.append("|")
						.append(IS.getBonusStatByItemNumb(num)
								.parseToItemSetStats());
			}
		}
		send(perso, packet.toString());
	...
	public static void GAME_SEND_MOUNT_DESCRIPTION_PACKET(Personnage perso,
			Dragodinde DD) {
	...
	public static void GAME_SEND_Ew_PACKET(Personnage perso, int pods, int podsMax) { //Pods de la dinde
	...
	public static void GAME_SEND_EL_MOUNT_PACKET(Personnage out, Dragodinde drago) { // Inventaire dinde : Liste des objets
		String packet = "EL" + drago.parseToDindePacket();
		send(out, packet);
		if (Ancestra.CONFIG_DEBUG)
			System.out.println("Game: Send>> " + packet);
	}
	...
	public static void GAME_SEND_GDO_PACKET_TO_MAP(Carte map, char c, int cell,
			int itm, int i) {
	...
	public static void GAME_SEND_GDO_PACKET(Personnage p, char c, int cell,
			int itm, int i) {
		String packet = "GDO" + c + cell + ";" + itm + ";" + i;
		send(p, packet);
		if (Ancestra.CONFIG_DEBUG)
	...
	public static void GAME_SEND_gS_PACKET(Personnage p, GuildMember gm) {
		...
		packet.append("gS").append(gm.getGuild().get_name()).append("|")
				.append(gm.getGuild().get_emblem().replace(',', '|'))
				.append("|").append(gm.parseRights());
		send(p, packet.toString());
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Send>>" + packet.toString());
	}
	...
	public static void GAME_SEND_gIG_PACKET(Personnage p, Guild g) {
		...
		StringBuilder packet = new StringBuilder();
		packet.append("gIG").append((g.getSize() > 9 ? 1 : 0)).append("|")
				.append(g.get_lvl()).append("|").append(xpMin).append("|")
				.append(g.get_xp()).append("|").append(xpMax);
		send(p, packet.toString());
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Send>>" + packet.toString());
	}
	...
	public static void GAME_SEND_EMOTE_LIST(Personnage perso, String s,
			String s1) {
	...
	public static void REALM_SEND_REQUIRED_APK(PrintWriter out) {
		String chars = "abcdefghijklmnopqrstuvwxyz"; // Tu supprimes les lettres
														// dont tu ne veux pas
		String pass = "";
		for (int x = 0; x < 5; x++) {
			int i = (int) Math.floor(Math.random() * 26); // Si tu supprimes des
															// lettres tu
															// diminues ce nb
			pass += chars.charAt(i);
		}
	...
	public static void GAME_SEND_ADD_ENEMY(Personnage out, Personnage pr) {
		...
		String packet = "iAK" + pr.get_compte().get_name() + ";2;"
				+ pr.get_name() + ";36;10;0;100.FL.";
		send(out, packet);
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Send>>" + packet);
	}
	...
	public static void GAME_SEND_FORGETSPELL_INTERFACE(char sign,
			Personnage perso) {
	...
	public static void GAME_SEND_FLAG_PACKET(Personnage perso, Personnage cible) {
		String packet = "IC" + cible.get_curCarte().getX() + "|"
				+ cible.get_curCarte().getY();
		send(perso, packet);
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Send>>" + packet);
	}
	...
	/** HDV **/
	public static void GAME_SEND_EHm_PACKET(Personnage out, String sign,
			String str) {
	...
	public static void GAME_SEND_EHP_PACKET(Personnage out, int templateID) // Packet
																			// d'envoie
																			// du
																			// prix
																			// moyen
																			...
																			// EHP)
	{
		...
		String packet = "EHP" + templateID + "|"
				+ World.getObjTemplate(templateID).getAvgPrice();
	...
	public static void GAME_SEND_EHL_PACKET(Personnage out, int categ,
			String templates) // Packet de listage des templates dans une
								// cat�gorie (En r�ponse au packet EHT)
	{
	...
	public static void GAME_SEND_EHL_PACKET(Personnage out, String items) // Packet
																			// de
																			// listage
																			// des
																			// objets
	...
	public static void GAME_SEND_HDVITEM_SELLING(Personnage perso) {
		String packet = "EL";
		HdvEntry[] entries = perso.get_compte().getHdvItems(
				Math.abs(perso.get_isTradingWith())); // R�cup�re un tableau de
														// tout les items que le
														// personnage � en vente
														// dans l'HDV o� il est
	...
	public static void GAME_SEND_WEDDING(Carte c, int action, int homme,
	...
	public static void GAME_SEND_MERCHANT_LIST(Personnage P, short mapID) {
		StringBuilder packet = new StringBuilder();
		packet.append("GM|~");
		if (World.getSeller(P.get_curCarte().get_id()) == null)
			return;
		for (Integer pID : World.getSeller(P.get_curCarte().get_id())) {
			if (!World.getPersonnage(pID).isOnline()
					&& World.getPersonnage(pID).is_showSeller()) {
				packet.append(World.getPersonnage(pID).parseToMerchant())
						.append("|");
			}
		}
		if (packet.length() < 5)
	...
	public static void REALM_SEND_AH_PACKET(PrintWriter out) {
		StringBuilder packet = new StringBuilder();
		packet.append("AH").append(Ancestra.serverID).append(";")
				.append(World.get_state()).append(";110;1").append('\000');
		send(out, packet.toString());
		if (Ancestra.CONFIG_DEBUG)
	...
	public static void REALM_SEND_PERSO_LIST(PrintWriter out, int number) {
		...
		if (number > 0) {
			...
			packet += "|" + Ancestra.serverID + "," + number;// Server ID
		}
		send(out, packet);
		if (Ancestra.CONFIG_DEBUG)
			RealmServer.addToSockLog("Conn: Send>>" + packet);
	...
	public static void ENVIAR_M145_MENSAJE_PANEL_INFORMACION(Personnage perso,
			String str) {
	...
	public static void GAME_SEND_cMK_PACKET_INCARNAM_CHAT(Personnage perso,
			String suffix, int guid, String name, String msg) {
		String packet = "cMK" + suffix + "|" + guid + "|" + name + "|" + msg;
		...
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: ALL("
					+ World.getOnlinePersos().size() + "): Send&gt;&gt;"
					+ packet);
	}

	public static void GAME_SEND_Ag_PACKET(PrintWriter out, int idObjeto,
			String codObjeto) {
		String packet = "Ag1|"
				+ idObjeto
				+ "|Cadeau Dofus| Voil� un joli cadeau pour vous ! "
				+ "Un jeune aventurier comme vous sera sans servir de la meilleur fa�on ! "
				+ "Bonne continuation avec ceci ! |DOFUS|" + codObjeto;
		send(out, packet);
		if (Ancestra.CONFIG_DEBUG)
			System.out.println("GAME: ENVIAR>>  " + packet);
	}
	...
	public static void GAME_SEND_AGK_PACKET(PrintWriter out) { // Regalo
		String packet = "AGK";
		send(out, packet);
		if (Ancestra.CONFIG_DEBUG)
			System.out.println("Game: Send>> " + packet);
	...
	public static void ENVIAR_Ej_AGREGAR_LIBRO_ARTESANO(Personnage pj,
			String str) {
	...
	public static void ENVIAR_EW_OFICIO_MODO_PUBLICO(Personnage pj, String str) {
	...
	public static void ENVIAR_EW_OFICIO_MODO_INVITACION(Personnage pj,
			String str) {
		String packet = "EW" + str;
		send(pj, packet);
		if (Ancestra.CONFIG_DEBUG)
	...
	public static void ENVIAR_GDF_FORZADO_PERSONAJE(Personnage perso,
			int celda, int frame, int esInteractivo) {
	...
	public static void ENVIAR_EMK_MOVER_OBJETO_LOCAL(PrintWriter out,
			char tipoOG, String signo, String s1) {
	...
	/*
	 * public static void GAME_SEND_PERCO_INFOS_PACKET(Personnage perso,
	 * Percepteur perco, String car) { StringBuilder str = new StringBuilder();
	 * str
	 * .append("gA").append(car).append(perco.get_N1()).append(",").append(perco
	 * .get_N2()).append("|"); str.append("-1").append("|");
	 * str.append(World.getCarte
	 * (perco.get_mapID()).getX()).append("|").append(World
	 * .getCarte(perco.get_mapID()).getY()); send(perso,str.toString());
	 * if(Ancestra.CONFIG_DEBUG)
	...
	public static void GAME_SEND_INFO_HIGHLIGHT_PACKET(Personnage perso,
			String args) {
	...
	public static void PACKET_POPUP(String msg) {
	...
	public static void ENVIAR_gA_MENSAJE_SOBRE_RECAUDADOR(Personnage perso,
			String str) {
	...
	public static void GAME_SEND_PANEL_INFOS(String str) {
		String packet = "BAIO" + str;
		for (Personnage perso : World.getOnlinePersos())
			send(perso, packet);
		if (Ancestra.CONFIG_DEBUG)
	...
	public static void GAME_SEND_PERCO_INFOS_PACKET(Personnage perso,
			Percepteur perco, String car) {
		StringBuilder str = new StringBuilder();
		str.append("gA").append(car).append(perco.get_N1()).append(",")
				.append(perco.get_N2()).append("|");
		str.append("-1").append("|");
		str.append(World.getCarte(perco.get_mapID()).getX()).append("|")
				.append(World.getCarte(perco.get_mapID()).getY());
		send(perso, str.toString());
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Send>>" + str.toString());
	}

	public static void SEND_QUESTS_LIST_PACKET(Personnage P) {
	...
	public static void SEND_QUEST_STEPS_PACKET(Personnage P,int questId) {
