...
public class ConditionParser {
	public static boolean validConditions(Personnage perso, String req) {
		...
		try {
			// Stats stuff compris
			jep.addVariable("CI",
					perso.getTotalStats().getEffect(Constants.STATS_ADD_INTE));
			jep.addVariable("CV",
					perso.getTotalStats().getEffect(Constants.STATS_ADD_VITA));
			jep.addVariable("CA",
					perso.getTotalStats().getEffect(Constants.STATS_ADD_AGIL));
			jep.addVariable("CW",
					perso.getTotalStats().getEffect(Constants.STATS_ADD_SAGE));
			jep.addVariable("CC",
					perso.getTotalStats().getEffect(Constants.STATS_ADD_CHAN));
			jep.addVariable("CS",
					perso.getTotalStats().getEffect(Constants.STATS_ADD_FORC));
			// Stats de bases
			jep.addVariable("Ci",
					perso.get_baseStats().getEffect(Constants.STATS_ADD_INTE));
			jep.addVariable("Cs",
					perso.get_baseStats().getEffect(Constants.STATS_ADD_FORC));
			jep.addVariable("Cv",
					perso.get_baseStats().getEffect(Constants.STATS_ADD_VITA));
			jep.addVariable("Ca",
					perso.get_baseStats().getEffect(Constants.STATS_ADD_AGIL));
			jep.addVariable("Cw",
					perso.get_baseStats().getEffect(Constants.STATS_ADD_SAGE));
			jep.addVariable("Cc",
					perso.get_baseStats().getEffect(Constants.STATS_ADD_CHAN));
			// Autre
	...
	public static String havePO(String cond, Personnage perso)// On remplace les
																// PO par leurs
																// valeurs si
																// possession de
																// l'item
...
public static String haveQE(String cond, Personnage perso) // Condition quete
{
	boolean Jump = false;
	...
	public static String canPN(String cond, Personnage perso)// On remplace le
																// PN par 1 et
																// si le nom
																// correspond ==
																// 1 sinon == 0
