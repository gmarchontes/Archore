...
public class Animations {
	...
	public Animations(int Id, int AnimId, String Name, int Area, int Action,
			int Size) {
		this.ID = Id;
	...
	public static String PrepareToGA(Animations animation) {
		...
		Packet.append(animation.getAnimationId()).append(",")
				.append(animation.getArea()).append(",")
				.append(animation.getAction()).append(",")
				.append(animation.getSize());
